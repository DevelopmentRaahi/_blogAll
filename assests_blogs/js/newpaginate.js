...
function paginate(totalPage, page) {
  ...
  if (page > 1) {
    liTag += ` <li class="prev" onClick= paginate(totalPage,${
      page - 1
    })><i class="fa-solid fa-arrow-left"></i> </li>`;
  }
  if (page > 2) {
  ...
  if (page < totalPage) {
    liTag += ` <li class="next" onClick= paginate(totalPage,${
      page + 1
    })><i class="fa-solid fa-arrow-right"></i></li>`;
  }
